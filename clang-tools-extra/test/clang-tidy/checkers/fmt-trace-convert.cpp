...
int main()
{
    ...
    // CHECK-MESSAGES: [[@LINE-1]]:11: warning: Replace TRACE format string [fmt-trace-convert]
    // CHECK-FIXES: TRACE("Goodbye {} trailing\nAnother line {}\n", 42, "wobble");

    TRACE2("Goodbye %s Wibble %d\n", "Hello", 42);
    // CHECK-MESSAGES: [[@LINE-1]]:12: warning: Replace TRACE format string [fmt-trace-convert]
